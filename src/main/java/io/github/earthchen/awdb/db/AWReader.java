...
import io.github.earthchen.awdb.exception.ClosedDatabaseException;
import io.github.earthchen.awdb.exception.InvalidDatabaseException;
import io.github.earthchen.awdb.exception.IpTypeException;
...
/**
 * Instances of this class provide a reader for the AW DB format. IP addresses can be looked up using the
...
public class AWReader implements Closeable {
    ...
    public enum FileMode {
        /**
         * The default file mode. This maps the database to virtual memory. This often provides similar performance to
         * loading the database into real memory without the overhead.
         */
        MEMORY_MAPPED,
        /**
    ...
    /**
     * Constructs a Reader for the AW DB format, with no caching. The file passed to it must be a valid AW DB file such
     * as a GeoIP2 database file.
     *
    ...
    /**
     * Constructs a Reader for the AW DB format, with the specified backing cache. The file passed to it must be a valid
     * AW DB file such as a GeoIP2 database file.
     *
     * @param database the AW DB file to use.
    ...
    /**
     * Constructs a Reader with no caching, as if in mode {@link FileMode#MEMORY}, without using a <code>File</code>
     * instance.
     *
    ...
    /**
     * Constructs a Reader with the specified backing cache, as if in mode {@link FileMode#MEMORY}, without using a
     ...
     *
     * @param ipAddress the IP address to look up.
     * @return the record for the IP address. If there is no data for the address, the non-null {@link Record} will
     * still be returned.
     * @throws IOException if a file I/O error occurs.
     */
     ...
     * the buffer to <code>null</code>, allowing the garbage collector to collect it.
     * </p>
     *
