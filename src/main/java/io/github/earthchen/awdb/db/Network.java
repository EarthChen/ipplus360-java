...
public final class Network {
     ...
     *
     * @param ipAddress    An IP address in the network. This does not have to be the first address in the network.
    ...
    /**
     * @return The prefix length is the number of leading 1 bits in the subnet mask. Sometimes also known as netmask
     * length.
     */
